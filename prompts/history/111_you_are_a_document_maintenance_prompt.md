# Executed: 2026-05-14T12:34:56.596263
...
Overwrite the file at `README.md` with the refreshed content. Do not create a new file — write directly to the existing path. Git provides rollback if needed.
