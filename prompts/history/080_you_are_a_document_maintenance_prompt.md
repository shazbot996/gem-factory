# Executed: 2026-04-15T13:26:35.325092
...
- **Path:** `docs/specs/api-server-SPEC.md`
- **Type:** `spec`
...
Overwrite the file at `docs/specs/api-server-SPEC.md` with the refreshed content. Do not create a new file — write directly to the existing path. Git provides rollback if needed.
